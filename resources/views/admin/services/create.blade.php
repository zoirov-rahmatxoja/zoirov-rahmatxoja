                        ...
                        <form action="{{ route('services.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('title_uz') is-invalid @enderror" name="title_uz"></textarea>
                                    <script>
                                ...
                                <div class="col-12 form-group mb-3">
                                    ...
                                    <script src="{{ asset('js/ckeditor/ckeditor.js') }}"></script>
                                    <textarea class="form-control @error('title_ru') is-invalid @enderror" name="title_ru"></textarea>
                                    <script>
