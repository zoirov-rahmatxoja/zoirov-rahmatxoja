...
@section('main')
    <div class="main-content">
        <div class="breadcrumb">
            ...
            <ul>
                <li><a href="{{ route('company.create') }}">Добавить новые данные</a></li>
            </ul>
        </div>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        @foreach($company as $com)
                                            <tr>
                                                ...
                                                <td class="d-flex">
                                                    <a class="text-success mr-2" href="{{ route('company.edit', $com->id) }}"><i class="nav-icon fas fa-pen font-weight-bold"></i></a>
                                                    <a data-toggle="modal" data-target="#deletesModal{{$com->id}}" class="text-danger mr-2" href="{{ route('company.destroy', $com->id) }}"><i class="nav-icon far fa-times-circle font-weight-bold"></i></a>
